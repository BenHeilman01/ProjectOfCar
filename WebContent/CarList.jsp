  ...
  <body>
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <h1 class="jumbotron-heading">Heilman's Car Market</h1>
          <p class="lead text-muted">Welcome to the Heilman's Car Market!  Please click a car if you would like a closer look or goto our "Sell A Car" link at the top of the page to sell you car.</p>
          <p>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="pics/Bat.jpg">
                
                <div class="card-body">
                  <p class="card-text"><c:forEach items="${carInv}" var="item">
    				${item.name}<br></c:forEach></p>
