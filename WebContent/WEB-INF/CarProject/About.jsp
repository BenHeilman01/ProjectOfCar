...
<div class="card" style="width: 18rem;">
  <img src="pics/20 i4.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Ben Heilman</h5>
    <p class="card-text">You can reach the owner by calling 314-566-2689, emailing @ ben_heilman@yahoo.com, or stopping in at the store @ 435 Olive Street - St. Louis, MO 63123.</p>
    <a href="http://localhost:8080/ServletProject/Test.jsp" class="btn btn-primary">Home</a>
    <li><a href="http://localhost:8080/ServletProject/CarInvPage.jsp">Sell A Car</a></li>
    <li><a href="http://localhost:8080/ServletProject/CarSearch.jsp">Search By Model</a></li>
  </div>
</div>
